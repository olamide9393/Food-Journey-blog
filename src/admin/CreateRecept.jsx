...
<h1 style={{textAlign:'center'}}>ADD A RECEPT</h1>


<div>
      <form className='container mt-5' ref={formRef} style={{ fontSize: '20px' }}>
            <div>
            <label htmlFor="name"> Recept image:</label>
            <br />
            ...
            <div>
                  <label htmlFor="name"> Recept tittle:</label>
            ...
            <div>
                  <label htmlFor="email">Recept ingredients:</label>
            ...
            <div>
                  <label htmlFor="email">recept description:</label>
